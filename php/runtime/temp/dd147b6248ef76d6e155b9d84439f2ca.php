<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\wamp64\www\qwdz\public/../application/admin\view\showroom\typelist.html";i:1531894409;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1531894263;}*/ ?>
﻿<!DOCTYPE html>
<!--
...
<!-- /Navbar -->
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption">空间编辑</span>
                    ...
                    <div class="widget-body">
                        <div class="table-toolbar">
                            <a id="editabledatatable_new" href="<?php echo url('showroom/addtype'); ?>" class="btn btn-success"><i class="fa fa-plus"></i>添加空间</a>
                            <button id="btn" onclick="return sort()" class="btn btn-magenta"><i class="fa fa-refresh"></i>更新排序</button>
                        </div>
                        <table class="table table-striped table-hover table-bordered dataTable no-footer" id="editabledatatable" aria-describedby="editabledatatable_info">
                            <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="editabledatatable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Username: activate to sort column ascending" style="width: 100px;">
                                        排序
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd">
                                    <td class="sorting_1">
                                        <input type="text" name="<?php echo $vo['id']; ?>" value="<?php echo $vo['sort']; ?>" style="width: 50px">
                                    </td>
                                    <td class="sorting_1"><?php echo $vo['tname']; ?></td>
                                    <td class=" ">
                                        <a href="<?php echo url('showroom/edittype',array('id'=>$vo['id'])); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>编辑</a>
                                        <!--<a href="<?php echo url('showroom/deltype',array('id'=>$vo['id'])); ?>" onclick="return confirm('确实要删除吗')?true:false" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i>删除</a>-->
                                        <button type="button" attrid="<?php echo $vo['id']; ?>" onclick="return del(this)" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i>删除</button>
                                    </td>
                                </tr>
    ...
    <script>
        function sort() {
            var url = "<?php echo url('showroom/sort'); ?>";
            var fromdata = new FormData($('#submit')[0]);
            layer.confirm('确定更新排序？', {
                btn: ['是','否'] //按钮
            }, function(){
                $.ajax({
                    type : "post",
       ...
       function del(obj) {
            var url = "<?php echo url('showroom/deltype'); ?>";
