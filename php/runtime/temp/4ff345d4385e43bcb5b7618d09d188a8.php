<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\wamp64\www\qwdz\public/../application/admin\view\admin\index.html";i:1529391874;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1531894263;}*/ ?>
﻿<!DOCTYPE html>
<!--
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption">管理员账号列表</span>
                    ...
                    <div class="widget-body">
                        <div class="table-toolbar">
                            <a id="editabledatatable_new" href="<?php echo url('admin/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i>添加管理员</a>
                        </div>
                        <table class="table table-striped table-hover table-bordered dataTable no-footer" id="editabledatatable" aria-describedby="editabledatatable_info">
                            ...
                            <tbody>
                                ...
                                <tr class="odd">
                                    ...
                                    <td class=" ">
                                        <a href="<?php echo url('admin/edit',array('id'=>$vo['id'])); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>编辑</a>
                                        <!--<a href="<?php echo url('admin/deltype',array('id'=>$vo['id'])); ?>" onclick="return confirm('确实要删除吗')?true:false" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i>删除</a>-->
