<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\wamp64\www\qwdz\public/../application/admin\view\store\index.html";i:1531894409;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1531894263;}*/ ?>
﻿<!DOCTYPE html>
<!--
...
<!-- /Navbar -->
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption">门店编辑</span>
                    ...
                    <div class="widget-body">
                        <div class="table-toolbar">
                            <a id="editabledatatable_new" href="<?php echo url('store/addstore'); ?>" class="btn btn-success"><i class="fa fa-plus"></i>添加门店</a>
                        </div>
                        <table  class="table table-striped table-hover table-bordered dataTable no-footer" id="editabledatatable" aria-describedby="editabledatatable_info">
                            ...
                            <tr class="odd" >
                                ...
                                <td class="sorting_1" ><?php echo $vo->city->name; ?></td>
                                <td class="sorting_1" ><?php echo $vo->tel; ?></td>
                                <td class="sorting_1" ><?php echo $vo->time; ?></td>
                                <td class="sorting_1" ><?php echo $vo->address; ?></td>
                                <td class="sorting_1">
                                    <a href='#' attrlogo="<?php echo $vo->logo; ?>" onclick="showLogo(this)"><img height="60" width="60" src="<?php echo $vo->logo; ?>"></a>
                                </td>
                                <td class=" ">
                                    <a href="<?php echo url('store/editstore',array('id'=>$vo->id)); ?>" class="btn btn-info btn-xs edit"><i class="fa fa-edit"></i>编辑</a>
                                    <!--<a href="<?php echo url('store/delstore',array('id'=>$vo->id)); ?>" onclick="return confirm('确实要删除吗')?true:false" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i>删除</a>-->
    ...
    <script>
        ...
        function delchecked() {
            ...
            layer.confirm('确定批量删除？', {
                ...
                if (data.length == 0){
                    ...
                    var url = "<?php echo url('store/dellotstore'); ?>";
                    $.ajax({
                        type : "post",
                        url  : url,
                        data : {"data" : data},
        ...
        function del(obj) {
            var url = "<?php echo url('store/delstore'); ?>";
