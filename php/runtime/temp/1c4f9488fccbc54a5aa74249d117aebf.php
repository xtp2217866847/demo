<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\wamp64\www\qwdz\public/../application/admin\view\showroom\addtype.html";i:1531894409;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1531894263;}*/ ?>
<!DOCTYPE html>
<!--
        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <span class="widget-caption">新增空间</span>
...
<script>
    $('#btn').click(function () {
        var url = "<?php echo url('showroom/addtype'); ?>";
        var tname = $('#tname').val();
        $.ajax({
            type : "post",
            url  : url,
