<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\wamp64\www\qwdz\public/../application/admin\view\league\detail.html";i:1527666438;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1528072050;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1528687789;}*/ ?>
<!DOCTYPE html>
<!--
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                ...
                <a href="<?php echo url('league/index'); ?>">加盟信息管理</a>
            </li>
            <li class="active">个人加盟详情</li>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
    <!-- Page Header -->
        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <span class="widget-caption">个人加盟详情</span>
                    ...
                    <div id="horizontal-form">
                        <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" id="name" name="name"  type="text" value="<?php echo $list['name']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">手机</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled"  type="text" value="<?php echo $list['mobile']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">商城</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['store']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">传真</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['fax']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">座机</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['tel']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">经营方式</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['fruit']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">经营品牌</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['brand']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">常住人口</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['perpop']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">开业时间</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['opentime']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">店铺面积</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['area']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">流动人口</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['floatpop']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">经营模式</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['model']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">投入资金</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['money']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">当地情况</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['local']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label no-padding-right">其他说明</label>
                                <div class="col-sm-6">
                                    <input class="form-control" disabled="disabled" type="text" value="<?php echo $list['other']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <a href="<?php echo url('league/index'); ?>" class="btn btn-info btn-xs btn-success">返回</a>
                                </div>
                            </div>
                        </form>
                    </div>
