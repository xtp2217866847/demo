<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\wamp64\www\qwdz\public/../application/admin\view\store\addstore.html";i:1531894409;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1531894263;}*/ ?>
<!DOCTYPE html>
<!--
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <div id="horizontal-form">
                        <form id="submit" class="form-horizontal" role="form" enctype="multipart/form-data" ><!--action="<?php echo url('store/addstore'); ?>" method="post">-->
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right">地区</label>
                                <div class="col-sm-6">
                                    <select id="pid" onchange="findCity()">
                                        <option value="0">请选择</option>
                                        <?php if(is_array($city) || $city instanceof \think\Collection || $city instanceof \think\Paginator): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$to): $mod = ($i % 2 );++$i;?>
...
<script>
    $('#btn').click(function () {
        var url = "<?php echo url('store/addstore'); ?>";
