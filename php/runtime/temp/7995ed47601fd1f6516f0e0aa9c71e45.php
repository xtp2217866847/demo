<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\wamp64\www\qwdz\public/../application/admin\view\showroom\edittype.html";i:1529395571;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1529374580;}*/ ?>
<!DOCTYPE html>
<!--
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                ...
                <a href="<?php echo url('showroom/typelist'); ?>">空间管理</a>
            </li>
            <li class="active">修改空间</li>
        </ul>
    </div>
    <!-- /Page Breadcrumb -->
    <!-- Page Header -->
        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header">
                    <span class="widget-caption">修改空间</span>
                ...
                <div class="widget-body">
                    <div id="horizontal-form">
                        <form class="form-horizontal" role="form" >
                            <input type="hidden" value="<?php echo $type['id']; ?>" id="id">
                            <div class="form-group">
                                <label for="tname" class="col-sm-2 control-label no-padding-right">空间</label>
                                <div class="col-sm-6">
                                    <input class="form-control"  id="tname"  name="tname" value="<?php echo $type['tname']; ?>" type="text" >
                                </div>
...
<script>
    $('#btn').click(function () {
        var url = "<?php echo url('showroom/edittype'); ?>";
        var tname = $('#tname').val();
        var id = $('#id').val();
        $.ajax({
            type : "post",
            ...
            success : function(data){
                ...
                if (data.status==1){
                    layer.msg(data.msg,{icon: 1,time: 1000},function () {
                        window.location.href = "<?php echo url('showroom/typelist'); ?>";
                    });
                } else {
