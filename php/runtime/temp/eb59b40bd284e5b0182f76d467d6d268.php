<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp64\www\qwdz\public/../application/admin\view\admin\add.html";i:1529393045;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1529374580;}*/ ?>
<!DOCTYPE html>
<!--
                    ...
                    <div id="horizontal-form">
                        <form class="form-horizontal" role="form" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="username"  name="username" placeholder="4~8位字母数字" type="text">
                                </div>
                                <p class="help-block col-sm-4"><span id="namerule" ></span></p>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-sm-2 control-label no-padding-right">管理员密码</label>
                                <div class="col-sm-6">
                                    <input class="form-control" id="password"  name="password" placeholder="4~8位字母数字" type="text">
                                </div>
                                <p class="help-block col-sm-4"><span id="pwdrule" ></span></p>
                            </div>
                            <!--<div class="form-group">
                                ...
                                <p class="help-block col-sm-4 "><span id="repeat" ></span></p>
                            </div>-->
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="button" id="btn" class="btn btn-success">保存信息</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    $('#username').blur(function () {
        ...
        var ret = /^[a-zA-Z0-9]{4,8}$/ ;
        var rule = $('#namerule');
        if (ret.test(name)){
            rule.attr("class","glyphicon glyphicon-ok");
            rule.attr("style","color: green");
            rule.text("账号格式正确");
        }else {
            rule.attr("class","glyphicon glyphicon-remove");
            rule.attr("style","color: red");
            rule.text("账号格式错误！");
        }
    })
    ...
    $('#password').blur(function () {
        ...
        if (repwd.val() !== ''){
            ...
            if(pwd1 !== ''){
                if (pwd1 == pwd2){
                    rule1.attr("class","glyphicon glyphicon-ok");
                    rule1.attr("style","color: green");
                    rule1.text("密码一致");
                }else{
                    rule1.attr("class","glyphicon glyphicon-remove");
                    rule1.attr("style","color: red");
                    rule1.text("两次密码不一致！");
                }
            }
        }*/
   ...
   /* $('#repassword').blur(function () {
    ...
    $('#btn').click(function () {
        ...
        /*if ($('#repassword').val()=='') {
            layer.msg("重复密码不为空",{icon: 5});
            return false;
        }*/
        if ($('#namerule').attr('class')=='glyphicon glyphicon-remove') {
            layer.msg($('#namerule').text(),{icon: 5});
            return false;
        }
        if ($('#pwdrule').attr('class')=='glyphicon glyphicon-remove') {
            layer.msg($('#pwdrule').text(),{icon: 5});
            return false;
        }
       /* if ($('#repeat').attr('class')=='glyphicon glyphicon-remove') {
            layer.msg($('#repeat').text(),{icon: 5});
            return false;
        }*/

        var url = "<?php echo url('admin/add'); ?>";
