<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wamp64\www\qwdz\public/../application/admin\view\admin\edit.html";i:1529395600;s:60:"E:\wamp64\www\qwdz\application\admin\view\common\header.html";i:1529373481;s:58:"E:\wamp64\www\qwdz\application\admin\view\common\left.html";i:1529374580;}*/ ?>
<!DOCTYPE html>
<!--
                    ...
                    <div id="horizontal-form">
                        <form class="form-horizontal" role="form" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="username" name="username" value="<?php echo $user['username']; ?>" placeholder="4~8位字母数字" type="text">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="password"  name="password" value="<?php echo $user['password']; ?>" placeholder="4~8位字母数字" type="text">
                                </div>
...
<script>
    ...
    $('#btn').click(function () {
        ...
        var url = "<?php echo url('admin/edit'); ?>";
        var id = $('#id').val();
